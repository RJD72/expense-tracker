function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}var t=globalThis,r={},n={},i=t.parcelRequire94c2;null==i&&((i=function(e){if(e in r)return r[e].exports;if(e in n){var t=n[e];delete n[e];var i={id:e,exports:{}};return r[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){n[e]=t},t.parcelRequire94c2=i);var s=i.register;s("kDiTP",function(t,r){e(t.exports,"signInUser",()=>h),e(t.exports,"signOutUser",()=>c),e(t.exports,"monitorAuthState",()=>f);var n=i("8hoa6");i("6AR8M");var s=i("guynj");let o=new s.X;o.setCustomParameters({prompt:"select_account"});let a=document.getElementById("googleSignInBtn"),l=document.getElementById("googleSignOutBtn"),u=document.getElementById("userInfo");function h(){(0,s.c)(n.auth,o).then(e=>{console.log("Signed in:",e.user)}).catch(e=>{console.error("Sign-in error:",e)})}function c(){(0,s.C)(n.auth).then(()=>{console.log("Signed out")}).catch(e=>{console.error("Sign-out error:",e)})}function f(e){(0,s.y)(n.auth,t=>{t?(u.textContent=`Logged in as ${t.displayName}`,a.style.display="none",l.style.display="block",e&&e(t)):(u.textContent="",a.style.display="block",l.style.display="none",e&&e(null))})}}),s("8hoa6",function(t,r){e(t.exports,"db",()=>l),e(t.exports,"auth",()=>u),i("fhN3L");var n=i("7xvHX");i("ilpIi");var s=i("9HrqM");i("6AR8M");var o=i("guynj");let a=(0,n.initializeApp)({apiKey:"AIzaSyBfi4qBrJnQ-E2Sln8D7UZcV46lWSAMA70",authDomain:"budget-planner-3ba38.firebaseapp.com",projectId:"budget-planner-3ba38",storageBucket:"budget-planner-3ba38.firebasestorage.app",messagingSenderId:"254257477383",appId:"1:254257477383:web:9d7cac52150da77391b7a2"}),l=(0,s.getFirestore)(a),u=(0,o.o)(a)}),s("fhN3L",function(t,r){e(t.exports,"initializeApp",()=>i("7xvHX").initializeApp),e(t.exports,"registerVersion",()=>i("7xvHX").registerVersion),/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tR extends eM{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return eq(e,this._buildIdpRequest())}_linkToIdToken(e,t){return eq(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return eq(e,this._buildIdpRequest())}_buildIdpRequest(e){let t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function tN(e){return te(e.auth,new tR(e),e.bypassAuthState)}function tD(e){let{auth:t,user:r}=e;return w(r,t,"internal-error"),e9(r,new tR(e),e.bypassAuthState)}async function tO(e){let{auth:t,user:r}=e;return w(r,t,"internal-error"),e7(r,new tR(e),e.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
